...
/** TODO(email): khôi phục form resetPassword khi bật lại mail + create PasswordResetToken. */
  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        >
          <p className="font-semibold">Tạm thời chưa hỗ trợ đặt lại mật khẩu qua email.</p>
          <p className="mt-2 font-normal text-amber-900/90">
            Vui lòng liên hệ trung tâm qua Zalo để được hỗ trợ.
          </p>
          <p className="mt-3">
            <a
